...
class SignUp extends Component {
    ...
    render() {
        return (
            <form onSubmit={this.signUpSubmitHandler} className="SignUpform"> 
            <div className="form-group col-md-4">
               ...
               <Link to="/Inventory"> <button type="submit"component={SignUp} className="btn btn-primary">Sign Up</button></Link>
            </form>
        )
    }
}
